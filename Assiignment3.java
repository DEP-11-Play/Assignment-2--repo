...
public class Assiignment3 {
    ...
    public static void main(String[] args) {
        ...
        age =scanner.nextInt();
        //scanner.nextLine(); // Use these methods after nextInt,double 
...
//--------------------(SUBJECT 1)-----------------------------------------------------
  ...
  //--------------------(SUBJECT 2)-----------------------------------------------------
        ...
        if(subject2.isBlank()){
            ...
            System.out.printf(ERROR_MSG,"Invalid Subject 2: Subject already exists");
            break app;
        }
...
//--------------------(SUBJECT 3)-----------------------------------------------------
        ...
        if(subject3.isBlank()){
            ...
            System.out.printf(ERROR_MSG,"Invalid Subject 3: Subject already exists");
            break app;
        }
